=== YouTube Video Gallery and Management ===
...
* Change videos slug
* Configured to work with [eMD CSV Import Export Extension](https://emdplugins.com/plugins/emd-csv-import-export-extension/) for bulk import/export from/to CSV files
...
8. [eMD CSV Import Export Extension](https://emdplugins.com/plugins/emd-csv-import-export-extension/) for bulk import/export from/to CSV files

== Changelog ==
= 2.5.1 =
* Fixed deleting WordPress category and tags taxonomies when clicked on 'Remove All Data' checkbox under Video Settings > Tools and deleted the plugin from WordPress Plugin page
= 2.5.0 =
