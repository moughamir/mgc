...
function wie_process_import_file( $file ) {
	...
	// File exists?
	if ( ! file_exists( $file ) ) {
		return new WP_Error('widget-import-error', __('Widgets import file could not be found.', 'widget-importer-exporter'));
	}
...
function wie_import_data( $data ) {
	...
	if ( empty( $data ) || ! is_object( $data ) ) {
		return new WP_Error('widget-import-error', __('Widgets import data could not be read.', 'widget-importer-exporter'));
