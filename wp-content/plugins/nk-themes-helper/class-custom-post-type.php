 ...
 */
 if (!class_exists('NK_Helper_Custom_Post_Type')) :
class NK_Helper_Custom_Post_Type {
    ...
    function register_post_type() {
        ...
        // Default labels.
        $labels = array(
            'name'               => sprintf( __( '%s', 'nk-themes-helper' ), $plural ),
            'singular_name'      => sprintf( __( '%s', 'nk-themes-helper' ), $singular ),
            'menu_name'          => sprintf( __( '%s', 'nk-themes-helper' ), $plural ),
            'all_items'          => sprintf( __( '%s', 'nk-themes-helper' ), $plural ),
                    ...
                    if ( is_array( $this->taxonomies ) ) {
                        ...
                        foreach( $this->taxonomies as $tax ) {
                            ...
                            if( $tax !== 'category' && $tax !== 'post_tag' ) {
                                ...
                                $new_columns[ $tax ] = sprintf( __( '%s', 'nk-themes-helper' ), $taxonomy_object->labels->name );
                            }
                        }
                    }
                }
        ...
        switch( $column ) {
            ...
            case ( taxonomy_exists( $column ) ) :
                ...
                // If no terms found.
                    ...
                    // Echo no terms.
                    printf( __( 'No %s', 'nk-themes-helper' ), $taxonomy_object->labels->name );
                }
            break;
            ...
            if ( ! empty( $filters ) ) {
                ...
                foreach ( $filters as $tax_slug ) {
                    ...
                    if ( $terms ) {
                        ...
                        // Default show all.
                        printf( '<option value="0">%s</option>', sprintf( __( 'Show all %s', 'nk-themes-helper' ), $tax->label ) );
