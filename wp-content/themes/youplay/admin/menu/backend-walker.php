...
add_action( 'wp_update_nav_menu_item', 'youplay_update_nav_menu_item', 10, 3 );
function youplay_update_nav_menu_item( $menu_id, $menu_item_db_id, $args ) {
    // Check if element is properly sent
    if ( is_array( $_REQUEST['menu-item-mega']) ) {
        $mega = $_REQUEST['menu-item-mega'][$menu_item_db_id];
        update_post_meta( $menu_item_db_id, '_menu_item_mega', $mega );
    }
}

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'youplay_edit_nav_menu_walker', 10, 2 );
function youplay_edit_nav_menu_walker($walker,$menu_id) {
