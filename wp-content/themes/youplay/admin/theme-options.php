...
function yp_custom_theme_options() {
  ...
  $custom_settings = array(
    'sections'        => array(
      ...
      array(
        'id'          => 'theme',
        'title'       => '<i class="fa fa-magic"></i> ' . esc_html__('Theme Style - w|p|l|o|c|k|e|r|.|c|o|m', 'youplay')
      ),
      array(
        'id'          => 'fonts',
      ...
      array(
        'id'          => 'seo',
        'title'       => '<i class="fa fa-line-chart"></i> ' . esc_html__('SEO [experimental]', 'youplay')
      ),
    ),
    'settings'        => array(
...
*/
      ...
      array(
        ...
        'label'       => esc_html__('Banners Overlay Opacity', 'youplay'),
        'desc'        => esc_html__('All banners overlay opacity', 'youplay'),
        'std'         => '50',
        'type'        => 'numeric-slider',
        'section'     => 'theme',
        'rows'        => '',
...
*/
      array(
        'id'          => 'maintenance',
        'label'       => esc_html__('Maintenance Mode - W`P`L`O`C`K`E`R`.`C`O`M`', 'youplay'),
        'desc'        => '',
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'maintenance',
...
*/
      array(
        'id'          => 'seo_enable',
        'label'       => esc_html__('Enable SEO helpers', 'youplay'),
        'desc'        => esc_html__('Don\'t enable it, if you use another SEO plugin or code.', 'youplay'),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'seo',
        'rows'        => '',
  ...
  echo ($has_desc ? '<div class="description">' . htmlspecialchars_decode( $field_desc ) . '</div>' : '');
    ...
    if ( class_exists( 'RevSliderAdmin' ) ) {
      ...
      if ( ! empty( $arrSliders ) ) {
        ...
        echo '<option value="">' . esc_html__( 'No Sliders Found', 'option-tree' ) . '</option>';
      }
      echo '</select>';
    } else {
        echo '<span style="color: red;">' . esc_html__( 'Sorry! Revolution Slider is not Installed or Activated', 'ventus' ). '</span>';
    }
    echo '</div>';
  echo '</div>';
}
