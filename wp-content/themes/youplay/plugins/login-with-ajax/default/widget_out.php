            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="lwa-register-form" action="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" method="post">
                        ...
                        <div class="youplay-input">
                            <input type="text" name="user_login" id="user_login-<?php echo esc_attr($NK_LWA_WIDGET_ID); ?>" class="input" size="20" tabindex="10" /></label>
                        </div>
                        ...
                        <div class="youplay-input">
                            <input type="text" name="user_email" id="user_email-<?php echo esc_attr($NK_LWA_WIDGET_ID); ?>" class="input" size="25" tabindex="20" /></label>
                        </div>
